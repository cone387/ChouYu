...
describe('Tasks 视图源守卫', () => {
  test('键盘与可达性:表单原生提交、Esc 取消、行内按钮 aria-label、列表 role', () => {
    const source = read('TasksView.tsx') + read('TaskEditorDialog.tsx') + read('TaskDatePicker.tsx') + read('TaskScheduleSettings.tsx')
