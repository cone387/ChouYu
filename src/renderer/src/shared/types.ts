...
import type { AppConfig, ResolvedProviderProfile } from '../../../shared/config'
...
export type { AppConfig, ProviderProfile, ResolvedProviderProfile } from '../../../shared/config'
...
export interface ElectronAPI {
  ...
  memory: {
    ...
    createTopic: (label: string, memoryIds: string[]) => Promise<MemoryCluster>
    splitCluster: (clusterId: string, memoryIds: string[], manual: boolean) => Promise<string[]>
